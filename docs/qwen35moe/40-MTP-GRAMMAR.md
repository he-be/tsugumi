...
| 8 | エージェント用途で一番効く制約は投機ではない | **prompt cache が無い**こと ([26 §4-3](26-PHASE8-SERVER.md))。2,935 トークンのターンで **TTFT 11.3 秒**、しかも**毎ターン全部**払う。MTP が返すのは decode の 14% で、この 11 秒には 1 秒も効かない (§6-1) |
