...
(**導出**、効率 100% の非現実的な上限)。**なお 150 GB/s 自体が楽観である** —
実物と同じ大きさの連続読み (lm_head の 540 MB) で出たのは **133〜135 GB/s**
([19 §4-2](19-LM-HEAD-INT8.md))。そちらで割ると Ornith の天井は **71 tok/s**。**decode は Gemma より速くなり得る、というのが
