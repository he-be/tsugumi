...
### 2-8. LM head — **INT4 ではなく INT8 の chain**(**書けた**)
...
([17 §5](17-PHASE2-KERNELS.md))。**両方とも済んだ** ([18](18-MIXED-BITS.md) /
[19](19-LM-HEAD-INT8.md))。実物の語彙で 1 トークン **4.0 ms / 134 GB/s**。
...
**そのとおりだった** — 引数だけで済み、マスクのコードは要らなかった
([19 §2](19-LM-HEAD-INT8.md))。
