...
Tsugumi builds on work by other developers and researchers. These are
...
- Hugging Face Transformers provides executable decoder cross-checks for
  ...
  Tsugumi used them to verify normalization, K/V derivation, routing,
...
- [Hugging Face swift-transformers](https://github.com/huggingface/swift-transformers)
  is the direct tokenizer dependency. Tsugumi adds bounded streaming
...
- [`image_processing_gemma4.py`](https://github.com/huggingface/transformers/blob/v5.6.2/src/transformers/models/gemma4/image_processing_gemma4.py)
  ...
  numerically, which is why Tsugumi does not chase bit-identity with
  either.
