...
Tsugumi repository source is licensed under the
[Apache License 2.0](LICENSE). That license applies to Tsugumi's own source
...
not redistribute weights as part of Tsugumi releases.
...
Vendored source (not in the package graph):
...
| [llama.cpp](https://github.com/ggml-org/llama.cpp) (portions) | `fe8156f78` | `Sources/Tsugumi/Metal/Quant/ggml_iq.metal` (IQ / K dense row arithmetic and lookup tables) | MIT (Copyright (c) 2023-2026 The ggml authors) |
