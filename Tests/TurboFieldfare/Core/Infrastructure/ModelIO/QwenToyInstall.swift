...
/// A tiny `.gturbo` shaped like Ornith-1.5-35B-A3B: three layers in four hold a
...
enum QwenToyInstall {
    ...
    struct Options {
        ...
        var directoryName = "gturbo-qwen-toy-\(UUID().uuidString)"
    }
    ...
    static func write(options: Options = Options()) throws -> URL {
        ...
        let stringTableBase = entriesBase + names.count * GTurboBinary.indexEntryBytes
        ...
        fileBuf.withUnsafeMutableBytes { raw in
            ...
            for (i, entry) in entries.enumerated() {
                GTurboBinary.writeIndexEntry(
                    into: base.advanced(by: entriesBase + i * GTurboBinary.indexEntryBytes),
        ...
        let manifestRoot: [String: Any] = [
            "magic": "GTURBO",
            "versionMajor": 1,
            "versionMinor": GTurboFormatV1.versionMinorLinearAttention,
