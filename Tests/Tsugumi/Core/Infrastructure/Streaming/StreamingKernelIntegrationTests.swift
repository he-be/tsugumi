...
/// End-to-end: write a synthetic .moepack blob containing one "expert" worth of
...
@Suite struct StreamingKernelIntegrationTests {
    ...
    /// Build the in-memory bytes that we'll write to the fake .moepack.
    ...
    @Test func endToEnd_streamFromFile_runKernel_matchesCpuReference() throws {
        ...
        let tmp = FileManager.default.temporaryDirectory
            .appendingPathComponent("tsugumi-smoke-\(UUID().uuidString).bin")
