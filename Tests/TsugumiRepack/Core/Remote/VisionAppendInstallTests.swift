...
struct VisionAppendInstallTests {
    ...
    @Test func addingTheTowerMatchesAFreshVisionInstall() async throws {
        ...
        #expect(try read(appended, MoEPackFormatV1.visionWeightsPath)
                == (try read(fresh, MoEPackFormatV1.visionWeightsPath)))
        ...
        #expect(manifest.files[MoEPackFormatV1.visionWeightsPath]?.size
        ...
        #expect(receiptFiles[MoEPackFormatV1.visionWeightsPath] != nil)
