...
@Suite struct MoEPackDirectoryAccessTests {
    ...
    @Test func enumerationToleratesEntriesRemovedDuringTheScan() async throws {
        let root = FileManager.default.temporaryDirectory
            .appendingPathComponent("moepack-\(UUID().uuidString)-scan")
    ...
    @Test func enumerationStillReportsSurvivingEntries() throws {
        let root = FileManager.default.temporaryDirectory
            .appendingPathComponent("moepack-\(UUID().uuidString)-scan-stable")
        try FileManager.default.createDirectory(at: root, withIntermediateDirectories: true)
        defer { try? FileManager.default.removeItem(at: root) }
    ...
    func enumerationFailsWhenASubdirectoryCannotBeRead() throws {
        let root = FileManager.default.temporaryDirectory
            .appendingPathComponent("moepack-\(UUID().uuidString)-scan-denied")
