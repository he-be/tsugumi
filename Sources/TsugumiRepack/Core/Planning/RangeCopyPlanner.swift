...
public enum RangeCopyPlanner {
    ...
    static func canonicalFingerprint(
        ...
        var writer = FingerprintWriter(domain: "Tsugumi.RemoteInstallPlan.v1")
        writer.append(UInt64(MoEPackJSON.versionMajor))
        writer.append(UInt64(MoEPackJSON.versionMinor))
