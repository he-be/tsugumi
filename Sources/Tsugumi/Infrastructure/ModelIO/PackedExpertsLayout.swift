...
enum PackedExpertsLayoutReader {
    static let defaultMaxBytes: UInt64 = MoEPackFormatV1.packedExpertsLayoutMaxBytes
    ...
    package static func decode(data: Data,
        ...
        let wire: MoEPackPackedExpertsLayoutV1
        do {
            wire = try MoEPackPackedExpertsLayoutCodec.decode(data)
            if let manifest {
