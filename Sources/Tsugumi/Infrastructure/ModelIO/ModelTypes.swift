...
enum ModelError: Error, CustomStringConvertible, Equatable {
    ...
    public var description: String {
        ...
        case .partialInstall(let p):
            return "model.moepack directory at \(p) is missing manifest.json"
        case .notAMoEPackDirectory:
            return "manifest.json magic does not equal \"MOEPACK\""
        ...
        case .missingFile(let n):
            return "model.moepack is missing required file \(n)"
