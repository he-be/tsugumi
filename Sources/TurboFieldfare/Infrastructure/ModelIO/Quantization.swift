...
public enum Quantization {
    ...
    public static func isSymmetric(scaleBits: UnsafeRawBufferPointer,
        ...
        GTurboAffineV1.isSymmetric(scaleBits: scaleBits, biasBits: biasBits)
    }
