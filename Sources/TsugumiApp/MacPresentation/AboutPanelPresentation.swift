...
public enum AboutPanelPresentation {
    public static let applicationName = "Tsugumi"
    ...
    private static let licenseURL = URL(
        string: "https://github.com/he-be/tsugumi/blob/main/LICENSE")!

    public static let repositoryURL = URL(string: "https://github.com/he-be/tsugumi")!

    public static let repositoryLinkText = "github.com/he-be/tsugumi"
    ...
    public static func credits() -> NSAttributedString {
        ...
        let licenseLead = "Tsugumi is licensed under the"
        let text = """
            \(repositoryLinkText)
            \(licenseLead)
            \(licenseName).
