...
// 788,175,872 groups of `scratch/gemma4-qat.moepack` (44 §1). A third and a bit
...
// `Sources/Tsugumi/` is touched, and §1 of the probe's output checks the
...
#define MOEPACK_AFFINE_GROUP_SIZE 32
#endif
...
/// every routed expert of `scratch/gemma4-qat.moepack` -- 16,220,160 rows -- one
...
final class BpwProbe {
    ...
    init(context: MetalContext, groupSize: Int, d: Int, f: Int) throws {
        ...
        options.preprocessorMacros = ["MOEPACK_AFFINE_GROUP_SIZE": NSNumber(value: groupSize)]
