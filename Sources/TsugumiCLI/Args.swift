...
/// type: it lives in `TsugumiServerCore`, which links NIO, and the CLI
...
extension Args {
    ...
    TsugumiCLI — Gemma 4 26B-A4B text generation

    usage: TsugumiCLI --model <dir> (--prompt <string> | --messages-file <path>) [options]

    required:
      --model <dir>             Path to a .moepack model directory.
